// src/dashboard/administrator/sections/InstructorSection.tsx
...
const InstructorSection: React.FC = () => {
  ...
  const handleViewProfile = (instructorId: number) => {
    console.log('Ver perfil del docente:', instructorId);
    alert(`Ver perfil del docente con ID: ${instructorId}`);
  };
